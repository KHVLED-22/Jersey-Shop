...
<div class="container py-2">
    ...
    if (isset($_POST['modifier'])) {
        ...
        if (!empty($libelle) && !empty($prix) && !empty($categorie)) {
            ...
            if (!empty($filename)) {
                ...
                $updated = $sqlState->execute([$libelle, $prix, $discount, $categorie, $description, $filename, $id,$quantite]);
            } else {
                $query = "UPDATE produit
                                                ...
                                                WHERE id = ? ";
                $sqlState = $pdo->prepare($query);
                $updated = $sqlState->execute([$libelle, $prix,$quantite, $discount, $categorie, $description, $id]);
            }
            if ($updated) {
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <textarea class="form-control" name="quantite"><?= $produit->quantite ?></textarea>
